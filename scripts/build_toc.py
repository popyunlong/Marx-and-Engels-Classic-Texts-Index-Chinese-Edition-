...
# 结构性书签噪声（精确匹配，不影响以「页」结尾的真实篇名如「材料的一页」「第375页」）。
# 扫描卷书签常带「封面页/书名页/前言页/目录页」等版面标记页，过滤之；真正的「前言」「目录」
# （无「页」尾）按既有项处理；注意「前言」是正文篇名不入此集（仅过滤「前言页」）。
NOISE_TITLES = {
    "封面", "书名", "版权", "版权页", "目录", "插图目录",
    "封面页", "书名页", "前言页", "目录页", "扉页", "插页",
    "封底", "封底页", "出版说明页",
}

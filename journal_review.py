...
from journal_taxonomy import DISCIPLINES, DISCIPLINE_HINTS

LOGGER = logging.getLogger(__name__)


# The shared taxonomy contains Marxism topic fields plus five general-philosophy
# fields.  This legacy review module keeps importing it for
# admin compatibility even though public email no longer contains a long AI review.
...
def _classification_system_prompt() -> str:
    ...
    lines.append(
        "归类原则：优先按文章的**研究主题/对象**择优；马克思主义理论领域与专题领域平级择优。"
        "文章是否由国外学者撰写、是否以英文发表均不是分类依据；政治经济学、发展研究、劳动研究等"
        "应进入对应专题领域，马克思主义流派、思想家或经典文本研究进入思想史与文本研究等对应领域。"

...
SITE_TEXT_DEFINITIONS = (
    ...
    SiteTextDefinition(
        "citation.nav_mobile_label",
        "论文插注校注",
        "移动端栏目简称",
        "论文校注",
        multiline=False,
    ),
    SiteTextDefinition("ai_page.title", "AI 研究对话", "栏目标题", "AI 研究对话", multiline=False),
    SiteTextDefinition(
        "ai_page.subtitle",
        "AI 研究对话",
        "栏目标题下方说明",
        "连续追问、带上下文的马克思主义经典研究问答",
    ),
    SiteTextDefinition("ai_page.quick_title", "AI 研究对话", "快速问答按钮标题", "快速问答", multiline=False),
    SiteTextDefinition(
        "ai_page.quick_description",
        "AI 研究对话",
        "快速问答按钮说明",
        "DeepSeek Flash · 即时对话 · 可选检索引文库佐证",
        multiline=False,
    ),
    SiteTextDefinition("ai_page.research_title", "AI 研究对话", "研究级检索按钮标题", "研究级检索", multiline=False),
    SiteTextDefinition(
        "ai_page.research_description",
        "AI 研究对话",
        "研究级检索按钮说明",
        "DeepSeek Pro · 深度长文 · 20–24 条真实引用",
        multiline=False,
    ),
    ...
    SiteTextDefinition(
        "index.chapter_search_hint_login",
        "首页",
        "篇章直达·未登录提示（{label} 为阅读器名称）",
        "登录后即可使用「{label}」篇章直达。",
        multiline=False,
    ),
    SiteTextDefinition(
        "index.chapter_search_hint_subscribe",
        "首页",
        "篇章直达·未开通会员提示（{label} 为阅读器名称）",
        "开通会员后即可使用「{label}」篇章直达。",
        multiline=False,
    ),
    SiteTextDefinition(
        "index.chapter_search_hint_unavailable",
        "首页",
        "篇章直达·功能未开放提示",
        "篇章直达功能暂未开放。",
        multiline=False,
    ...
    SiteTextDefinition("index.search_help_close_label", "首页", "检索使用提示关闭按钮说明", "收起提示", multiline=False),
    SiteTextDefinition(
    ...
    SiteTextDefinition(
        ...
        "首页",
        "同段多词检索开关说明",
        "同段多词检索（用空格分隔多个词，查找同一段落内同时出现的全部词）",
        multiline=False,
    ),
    SiteTextDefinition("index.search_submit", "首页", "检索提交按钮", "开始检索", multiline=False),
    SiteTextDefinition(
    ...
    SiteTextDefinition("index.journal_kicker", "首页", "期刊提醒功能栏小标题", "独立栏目 · 会员专享", multiline=False),
    SiteTextDefinition("index.journal_title", "首页", "期刊提醒功能栏标题", "国外文献精选周刊", multiline=False),
    SiteTextDefinition(
        "index.journal_description",
        "首页",
        "期刊提醒功能栏说明",
        "每周精选可由公开渠道取得 PDF 全文的英文马克思主义与哲学文献，提供中英目录、双语流式阅读与邮件文章卡片。",
    ),
    SiteTextDefinition("index.journal_action", "首页", "期刊提醒功能栏按钮", "进入国外文献精选周刊", multiline=False),
    SiteTextDefinition("index.journal_locked", "首页", "期刊提醒功能栏未开放按钮", "开通会员后阅读", multiline=False),
    ...
    SiteTextDefinition("index.registry_geo_total_label", "首页 · 注册用户分布", "总数后缀", "位注册用户", multiline=False),
    ...
    SiteTextDefinition("index.registry_geo_overseas_tpl", "首页 · 注册用户分布", "海外人数（{n} 为人数）", "🌏 海外 {n} 位", multiline=False),
    SiteTextDefinition("index.registry_geo_unknown_tpl", "首页 · 注册用户分布", "待识别人数（{n} 为人数）", "另有 {n} 位归属地待识别", multiline=False),
    SiteTextDefinition("index.registry_geo_foot", "首页 · 注册用户分布", "卡片底部说明", "依注册 / 登录地区聚合 · 每分钟更新", multiline=False),
    SiteTextDefinition("index.registry_geo_rank_empty", "首页 · 注册用户分布", "暂无地区数据提示", "暂无可定位的地区数据", multiline=False),
    ...
    SiteTextDefinition("index.registry_geo_color_zero", "首页 · 注册用户分布", "配色·无人省份", "#ece2d2", multiline=False),
    SiteTextDefinition("index.registry_geo_color_low", "首页 · 注册用户分布", "配色·低", "#f3ddc2", multiline=False),
    SiteTextDefinition("index.registry_geo_color_high", "首页 · 注册用户分布", "配色·高", "#7d1616", multiline=False),
    # —— 首页·每周读者动态卡片（控制台·内容运营可自助修改文案）——
    SiteTextDefinition("index.community_weekly_title", "首页 · 每周读者动态", "卡片标题", "每周读者动态", multiline=False),
    SiteTextDefinition("index.community_weekly_live", "首页 · 每周读者动态", "实时徽标文字", "每周", multiline=False),
    SiteTextDefinition("index.community_weekly_search_title", "首页 · 每周读者动态", "检索榜标题", "每周检索最多的词句", multiline=False),
    SiteTextDefinition("index.community_weekly_empty", "首页 · 每周读者动态", "暂无榜单数据提示", "本周样本积累中", multiline=False),
    SiteTextDefinition("index.community_weekly_foot", "首页 · 每周读者动态", "卡片底部小字说明", "展示前 6 条 · 本周不足时按排名沿用上周数据", multiline=False),
)
